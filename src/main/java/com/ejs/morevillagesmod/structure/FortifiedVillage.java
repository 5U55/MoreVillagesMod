...
public class FortifiedVillage extends StructureFeature<DefaultFeatureConfig> {
   public FortifiedVillage(Codec<DefaultFeatureConfig> codec) {
      super(codec);
   }

   public StructureFeature.StructureStartFactory<DefaultFeatureConfig> getStructureStartFactory() {
      return FortifiedVillage.Start::new;
   }
   ...
   public static class Start extends StructureStart<DefaultFeatureConfig> {
      ...
      public void init(DynamicRegistryManager dynamicRegistryManager, ChunkGenerator chunkGenerator, StructureManager structureManager, ChunkPos chunkPos, Biome biome, DefaultFeatureConfig FeatureConfig, HeightLimitView heightLimitView) {
         ...
         FortifiedVillageGenerator.addParts(structureManager, blockPos, blockRotation, this, this.random, FeatureConfig);
      }
   }
}
